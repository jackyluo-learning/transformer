...
if __name__ == '__main__':
    ...
    reference_sentence = 'hello this code is mine'
    ...
    # score = sentence_bleu(reference_token, candidate_token)
    reference = [['已', '已', '的']]
    candidate = ['已', '已', '的']
    ...
    train_sentences = ['how old is the man', 'this is a cat and not is a dog', 'it is a dragon', 'i like play ball']
